...
function slider_bin_enqueue_scripts() {
    ...
    // // Optionally enqueue Swiper library if needed
    // wp_enqueue_script('slider_bin_swiper_library', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.caroufredsel/6.2.1/jquery.carouFredSel.packed.js', array(), false, true);
